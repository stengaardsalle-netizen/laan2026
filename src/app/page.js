        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-14" id="hvad-er-laan">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[{title:'Lån med sikkerhed',items:['Boliglån','Billån','Lavere renter','Kræver pant'],href:'/boliglaan'},{title:'Lån uden sikkerhed',items:['Forbrugslån','Kviklån','Hurtigere behandling','Højere renter'],href:'/forbrugslaan'}].map((t,i)=>(
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-6 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div><h3 className="text-base font-bold text-white mb-4">Lånetyper</h3><ul className="space-y-3">{[{n:'Boliglån',h:'/boliglaan'},{n:'Forbrugslån',h:'/forbrugslaan'},{n:'Kviklån',h:'/kviklaan'},{n:'Billån',h:'/billaan'}].map((l,i)=>(<li key={i}><Link href={l.h} className="text-slate-400 hover:text-white transition-colors text-sm">{l.n}</Link></li>))}</ul></div>
