...
export default function HomePage() {
  ...
  const faqs = [
    ...
    { question: 'Er det sikkert at låne penge online?', answer: 'Ja, så længe du vælger en udbyder, der er under tilsyn af Finanstilsynet. I Danmark er der strenge krav til gennemsigtighed og markedsføring af lån, herunder et ÅOP-loft på 25% for forbrugslån. Tjek altid udbyderen på finanstilsynet.dk.' },
