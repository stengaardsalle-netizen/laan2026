          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-6 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div><h3 className="text-base font-bold text-white mb-4">Lånetyper</h3><ul className="space-y-3">{[{n:'Boliglån',h:'/boliglaan'},{n:'Forbrugslån',h:'/forbrugslaan'},{n:'Billån',h:'/billaan'}].map((l,i)=>(<li key={i}><Link href={l.h} className="text-slate-400 hover:text-white transition-colors text-sm">{l.n}</Link></li>))}</ul></div>
                <div className="mt-8 md:mt-0"><h3 className="text-base font-bold text-white mb-4">Information</h3><ul className="space-y-3">{[{n:'Lånevejledning',h:'/guide'},{n:'Kontakt',h:'/kontakt'},{n:'Om os',h:'/om-os'},].map((l,i)=>(<li key={i}><Link href={l.h} className="text-slate-400 hover:text-white transition-colors text-sm">{l.n}</Link></li>))}</ul></div>
              </div>
